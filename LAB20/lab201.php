...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <div class="jumbotron">
                <div class="container">
                    <h1 class="display-5">DS7 - Laboratorio 20.1</h1>
                    <p class="lead">Objetivo: Desarrollar aplicaciones web en PHP con manejo de mongoDB.</p>
                    <p class="lead">Formulario y procesamiento del mismo, para insertar registro y leer los existentes.
                    </p>
                    <hr class="my-1">
                </div>
            </div>
                ...
                <div class="row">
                    <div class='jumbotron-wc1 border border-white col-md-12'>
                        <div class="shadow-lg p-3 mb-2 m-2 bg-white text-primary rounded">
                            <h1 class='text-white bg-dark text-center'>ELIMINAR COOKIE</h1>
                        </div>
                        <div class="jumbotron-wc2 border border-white p-3 m-2">
                            <div class="shadow-lg p-3 mb-2 mx-5 bg-white text-primary rounded">
                                ...
                                echo "<br/>Registros en la coleccion usuarios:<br/>";

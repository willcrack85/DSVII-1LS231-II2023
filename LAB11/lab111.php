...
$_objNoticias   = new noticia ();
$_arrayNoticias = $_objNoticias->getListarNoticias ();
$nFilas         = count ( $_arrayNoticias );
define ( 'PAGE', 5 );
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron mx-3">
            <div class="container">
                <h1 class="display-5">DS7 - Laboratorio 11.1</h1>
            ...
            <div class="row m-1">
                <div class='jumbotron1 border border-white col-md-12'>
                    <div class="shadow-lg m-2 px-2 pt-2 bg-white text-primary rounded">
                        ...
                        ?>
                        <form name='formFiltro' method='post' action='lab111.php'>

...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <div class="jumbotron">
                <h1 class="display-5">DS7 - Laboratorio 13.3</h1>
                ...
                <div class="col-md-8 offset-md-2 text-center my-2">
                    <div class='jumbotron1 border border-white col-md-12'>
                        <div class="shadow-lg m-2 px-3 py-2 bg-white text-primary rounded">
                            <h1 class="text-center text-white bg-dark rounded">RECUPERAR VALOR DE UNA COOKIE</h1>
                        </div>
                        <div class="jumbotron2 border border-white p-3 m-2">
                            <div class="shadow-lg p-3 m-2 bg-white text-primary rounded">
                                <?php
                                if (isset($_COOKIE["user"])) {
                                    print("<p class='lead text-center m-4'>Bienvenido <kbd>" . $_COOKIE['user'] . "</kbd> </p>");
                                } else {
                                    print("<p class='lead text-center m-4'>Bienvenido invitado!</p>");
                                }
                                ?>
                                <div class="input-group">
                                    <div class='col-lg-12 mt-4 px-0 text-center'>
                                        <a href="lab132.php" class="btn btn-secondary btn-lg col-lg-4 col-lg-offset-2 mt-2 active" role="button" aria-pressed="true">&lt;&lt; Regresar</a>
                                        <a href="lab134.php" class="btn btn-primary btn-lg col-lg-4 col-lg-offset-2 mt-2 active" role="button" aria-pressed="true">Continuar &gt;&gt;</a>
                                    </div>
                                </div>
                            </div>
                        </div>

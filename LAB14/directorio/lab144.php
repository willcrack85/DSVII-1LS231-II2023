...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #62">
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <div class="jumbotron">
                <div class="container">
                    <h1 class="display-5">DS7 - Laboratorio 14.4</h1>
                    ...
                    <div class="row">
                        <div class='jumbotron1 border border-white col-md-12'>
                            <div class="shadow-lg m-2 p-3 bg-white text-primary rounded">
                                ...
                                <form name='frmFiltro' method='post' action='lab144.php'>
                                    <div class="input-group mb-0">
                                        ...
                                        <input type="text" name="valor" class="form-control"
                                            placeholder="Colocar el nombre a buscar" aria-label="Buscar"
                                            aria-describedby="txtgrupoSeleccion" id="wc-center">
                                        <div class="input-group-append" id="txtgrupoSeleccion">
                                            <button class="btn btn-outline-primary" type="submit"
                                                name="ConsultarFiltro">Filtrar
                                                Datos</button>
                                            <button class="btn btn-outline-success" type="submit" name="ConsultarTodos">Ver
                                                Todos</button>
                                        </div>
                                    </div>
                                </form>

...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #51">
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <div class="jumbotron">
                <h1 class="display-5">DS7 - Laboratorio 12.2</h1>
                        ...
                        <div class="jumbotron2 border border-white p-3 m-2">
                            <div class="shadow-lg p-3 mb-2 m-2 bg-white text-primary rounded">
                                ...
                                if (isset($_SESSION['var'])) {
                                    ...
                                    unset($_SESSION['var']);  //* para eliminar solamente var,
                                    print("<div class='form-group col-md-12 text-center'>");
                                    print("<a class='btn btn-success col-md-4 col-md-offset-4' href='lab123.php' role='button'>P&aacute;gina 3</a>");
                                    print("</div>");
                                } else {
                                    print("<div class='form-group col-md-12 text-center'>");
                                    print("<p>Sesi&oacute;n no iniciada, ir a al paso 1 para iniciar sesion</p>\n");
                                    print("<a class='btn btn-danger col-md-4 col-md-offset-4' href='lab121.php' role='button'>P&aacute;gina 1</a>");
                                    print("</div>");
                                }
                                ?>
                            </div>

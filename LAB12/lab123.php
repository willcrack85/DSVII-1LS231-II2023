...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #52">
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <div class="jumbotron">
                <h1 class="display-5">DS7 - Laboratorio 12.3</h1>
                        ...
                        <div class="jumbotron2 border border-white p-3 m-2">
                            <div class="shadow-lg p-3 mb-2 m-2 bg-white text-primary rounded">
                                ...
                                <div class='form-group col-md-12 text-center'>
                                    <a class='btn btn-primary active col-md-4 col-md-offset-4' href='lab121.php' role='button'>P&aacute;gina 1</a>
                                </div>
                            </div>
                        </div>
                        <hr class="my-1">

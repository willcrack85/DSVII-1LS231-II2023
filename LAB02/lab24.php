...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #12">
	...
	<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
		...
		<div class="row">
			<div class="cover-jumbotronWC text-center col-md-12 col-md-auto border border-white">
				<h1 class="display-4">DS7 - Laboratorio 2.4</h1>
                <p class="lead">Crear una aplicacion con arreglos asociativos (claves).</p>
                <hr class="my-4">

...
<meta charset="UTF-8">
    ...
    <meta name="description" content="Template con PHP en Laboratorio #1">
	...
	<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
		...
		<div class="row">
			<div class="cover-jumbotronWC text-center col-md-12 col-md-auto border border-white">
				<h1 class="display-4">DS7 - Laboratorio 1.1</h1>
				<p class="lead">Concatenar dos cadenas con el operador punto (.) e imprimir su resultado.</p>
                <hr class="my-4">
                <!-- Comentarios dentro de PHP -->
                <?php $ini = "Hola "; $fin = " a todos"; $todo = $ini.$fin;?>
                <p>Uni&oacute;n de las C&aacute;denas "<?php echo $ini;?>" y "<?php echo $fin;?>": <h2><?php echo $todo;?></h2></p>
            </div>
        </div>

...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #8">
	...
	<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
		...
		<div class="row">
			<div class="cover-jumbotronWC text-center col-md-12 col-md-auto border border-white">
				<h1 class="display-4">DS7 - Laboratorio 1.8</h1>
                <p class="lead">Manejo de variables II.</p>
                <hr class="my-4">
				<!-- Comentarios dentro de PHP -->
				<?php
					$a = 8;
                    $b = 3;
                    echo "<p class='h4'>", $a + $b, "<br></p>";
                    echo "<p class='h4'>", $a - $b, "<br></p>";
                    echo "<p class='h4'>", $a * $b, "<br></p>";
                    echo "<p class='h4'>", $a / $b, "<br></p>";
                    $a++; echo "<p class='h4'>", $a, "<br></p>";
                    $b--; echo "<p class='h4'>", $b, "<br></p>";
                ?>
            </div>
        </div>

...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #7">
	...
	<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
		...
		<div class="row">
			<div class="cover-jumbotronWC text-center col-md-12 col-md-auto border border-white">
				<h1 class="display-4">DS7 - Laboratorio 1.7</h1>
                <p class="lead">Manejo de variables.</p>
                <hr class="my-4">
				...
				<?php
                    ...
                    echo "<p class='h4'><del>", $x, "<br>", $pi, "<br>", $animal, "<br>", $saludo, "</del></p>";
                ?>
            </div>
        </div>

	...
	<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
		...
		<div class="row">
			<div class="cover-jumbotronWC text-center col-md-12 col-md-auto border border-white">
                ...
                <form name='frmDatos' method='POST' action='lab44a.php'>
                    <?php
                    $intNumeroPar;
                    $valor = $_POST['cont'];
                    ...
                    if($_REQUEST['vNumero'] != ""){
                        if($_REQUEST['vNumero'] % 2 == 0){
                            if(!$_POST['lblPar'] == null){
                                $intNumeroPar = $_POST['lblPar'].":".$_POST['vNumero'];
                            }else{
                                $intNumeroPar = $_POST['vNumero'];
                            }
                            if($_REQUEST['cont'] < 9){
                                $valor = $_POST['cont'] + 1;
                                ...
                                echo "<input type='hidden' name='cont1' value='$valor'>";
                                ...
                                echo "<br><h5>Ingresaste un valor que es par, te quedan faltante (",9-$_REQUEST['cont'],")...</h5>";
                                echo "</div>";   
                            }else{
                                echo "<div class='col-7 mt-3 mb-2'>";
                                echo "<label class='col-form-label'>Introdusca un N&uacute;mero par hasta llegar a (9):</label>";

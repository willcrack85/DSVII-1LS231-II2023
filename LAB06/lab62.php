...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #30">
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="mt-2">DS7 - Laboratorio 6.2</h1>
                <p class="lead">Clase + Instancia de objeto en DISTINTOS Archivos.</p>
                <hr class="my-1">
            </div>
        </div>
        <div class="container">
                        ...
                        <div class="row">
                            <div class='jumbotron1 border border-white col-md-12'>
                                ...
                                <div class="jumbotron2 bg-info border border-white">
                                    ...
                                    echo "<dd class='col-sm-6'>" . $Cliente1->dame_numero() . "</dd>";
                                    echo "</dl>";
                                    echo "<dl class='row'>";
                                    echo "<dt class='col-sm-5 ml-3'>El identificado del Cliente 2 es: </dt>";
                                    echo "<dd class='col-sm-6'>" . $Cliente2->dame_numero() . "</dd>";
                                    echo "</dl>";
                                    ?>
                                </div>
                                <hr class="my-4">

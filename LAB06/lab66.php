...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #34">
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="mt-5">DS7 - Laboratorio 6.6</h1>
                                            ...
                                            <th>
                                                <div class="jumbotron2 bg-info border border-white">
                                                    ...
                                                    final class ClaseBase
                                                    {
                                                        ...
                                                        // Aqui da igual si se declara el método como final o no.
                                                    ...
                                                    class ClaseHijo extends ClaseBase
                                                    {
                                                        ...
                                                        // //in C:\xampp\htdocs\codePHP\DSVII\lab06\lab66.php on line 104

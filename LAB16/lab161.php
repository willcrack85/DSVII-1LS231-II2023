...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #73">
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <div class="jumbotron">
                <div class="container">
                    <h1 class="display-5">DS7 - Laboratorio 16.1</h1>
                    <p class="lead">Consulta de Servicio Web de Conversi&oacute;n de Temperatura.</p>
                    <hr class="my-1">
                </div>
            </div>
                ...
                <div class="row">
                    <div class='jumbotron-wc1 border border-white col-md-12'>
                        <div class="shadow-lg px-2 py-2 mx-2 text-primary rounded">
                            <h1 class="text-center text-white bg-dark text-uppercase">Conversión de Temperatura</h1>
                        </div>
                        <div class="jumbotron-wc2 border border-white p-3 m-2">
                            <form name='frmConvertTemp' method='post' action='lab161.php'>
                                <div class="input-group mb-1">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="selectTitulo">Convertir
                                            desde:&nbsp;</label>
                                    </div>
                                    <select name="cbxTemp" class="custom-select" id="selectTitulo">
                                        <option value="CtoF" selected>&deg;C a &deg;F</option>
                                        <option value="FtoC">&deg;F a &deg;C</option>
                                    </select>
                                    <div class="input-group-prepend mr-2">
                                        <label class="input-group-text" for="selectTitulo">el valor</label>
                                    </div>
                                    <input type="number" name="txtValor" class="form-control mx-2"
                                        placeholder="N&uacute;mero" aria-label="Buscar"
                                        aria-describedby="txtgrupoSeleccion" id="wc-center" step="any" required>
                            ...
                            $parametros = array();
                            if ( array_key_exists ( 'btnConvertir', $_POST ) )
                                {
                                ...
                                echo ( "<div class='px-2 py-2 my-3 shadow-lg bg-light text-center rounded'>" );
                                echo ( "<p class='lead text-primary'>" );
                                print( "La temperatura $valor&nbsp;&deg;" . substr ( $temp, 0, 1 ) . " es igual a: $resultado&nbsp;&deg;" . substr ( $temp, 3, 1 ) );
                                echo ( "</p>" );
                                echo ( "</div>" );
                                }
                            ?>

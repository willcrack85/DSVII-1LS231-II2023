...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #39">
    <meta name="keywords" content="HTML5, CSS, Javascript" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="author" content="WillCrack Solution Corp.">
    <meta name="generator" content="WC 0.0.0">
    <title>Laboratorio 7.5</title>
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="mt-2">DS7 - Laboratorio 7.5</h1>
                <p class="lead">Clonaci&oacute;n de objetos.</p>
                <hr class="my-1">
            </div>
        </div>
        <div class="container">
                                        ...
                                        <tr>
                                            <th>
                                                <div class="jumbotron2 bg-info border border-white text-justify p-2 m-1">
                                                    ...
                                                    $obj1->object1 = new SubObject();
                                                    $obj1->object2 = new SubObject();

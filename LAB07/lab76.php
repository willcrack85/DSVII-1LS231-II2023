...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #40">
...
<body class="d-flex flex-column h-100">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="lab76.html">Inicio <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="mt-2">DS7 - Laboratorio 7.6</h1>
                <p class="lead">Uso de formulario en orientaci&oacute;n a objeto I.</p>
                <hr class="my-1">
            </div>
        </div>
        <div class="container">
                            ...
                            <div class='jumbotron1 border border-white col-md-12'>
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <th>
                                                <div class="jumbotron2 bg-info border border-white text-justify p-2 m-1">
                                                    <hr class="my-4">
                                                    <div class="form-group row">
                                                        <label for='cResultado1' class="col-sm-8 col-form-label text-left">Volumen de un Cilindro en mts. cubico.</label>
                                                        <div class="col-sm-4">
                                                            <input type='text' class="form-control text-center" id='cResultado1' placeholder='<?php printf("%.2f", $volumen); ?>' readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for='cResultado2' class="col-sm-8 col-form-label text-left">&Aacute;rea de un Cilindro en mts. cuadrados.</label>
                                                        <div class="col-sm-4">
                                                            <input type='text' class="form-control text-center" id='cResultado2' placeholder='<?php printf("%.2f", $area); ?>' readonly>
                                                        </div>
                                                    </div>
                                                    <hr class="my-4">
                                                </div>

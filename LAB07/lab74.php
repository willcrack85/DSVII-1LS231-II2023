...
<head>
    ...
    <meta name="description" content="Template con PHP en Laboratorio #38">
    <meta name="keywords" content="HTML5, CSS, Javascript" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="author" content="WillCrack Solution Corp.">
    <meta name="generator" content="WC 0.0.0">
    <title>Laboratorio 7.4</title>
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="mt-2">DS7 - Laboratorio 7.4</h1>
                <p class="lead">Auto carga de clases (no incluida en tiempo de dise&ntilde;o).</p>
                <hr class="my-1">
            </div>
        </div>
        <div class="container">
                            ...
                            <div class='jumbotron1 border border-white col-md-12'>
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <th>
                                                <div class="jumbotron2 pb-2 my-1 bg-info border border-white">
                                                    <?php
                                                    spl_autoload_register(function ($nombre_clase) {
                                                        $archivo = "class\\" . $nombre_clase . ".php";

...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <div class="jumbotron">
                <div class="container">
                    <h1 class="display-5">DS7 - Laboratorio 22</h1>
                    <p class="lead">Objetivo: Crear una imagen personalizada de la imagen phpid/xampp y que incluya
                        holamundo.php creado en la parte C de esta guía dentro de un nuevo contenedor utilizando
                        DockerFile.
                    </p>
                    <hr class="my-1">
                </div>
                ...
                <div class="row">
                    <div class='jumbotron-wc1 border border-white col-md-12'>
                        <div class="shadow-lg p-3 mb-2 m-2 bg-white text-primary rounded">
                            <h1 class='text-white bg-dark text-center'>Ejemplo b&aacute;sico PHP</h1>
                        </div>
                        <div class="jumbotron-wc2 border border-white p-3 m-2">
                            <div class="shadow-lg p-3 mb-2 mx-5 bg-white text-primary rounded">
                                <?php echo ( "<h1 class='text-center'>Hola Mundo - DS7 - 2022</h1>" ); ?>
                            </div>
                        </div>
                        <hr class="my-2">
